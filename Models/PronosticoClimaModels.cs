...
/// </summary>
public sealed class PronosticoClimaTerreno
{
    ...
    public PronosticoClimaResumen Resumen { get; set; } =
        new();

    public List<PronosticoClimaAlerta> Alertas { get; set; } =
        [];

    public List<PronosticoClimaDia> Dias { get; set; } =
        [];
}

public sealed class PronosticoClimaResumen
{
...
public sealed class PronosticoClimaDia
{
    ...
    // Se conserva para compatibilidad con respuestas anteriores.
    public List<string> Recomendaciones { get; set; } = [];

    public List<PronosticoClimaRecomendacion>
        RecomendacionesDetalladas { get; set; } = [];

    public List<PronosticoClimaPeriodo> Periodos { get; set; } = [];
...
public sealed class PronosticoClimaRecomendacion
{
    ...
    public List<PronosticoClimaEvidencia> Evidencias
    {
        get;
        set;
    } = [];
...
public sealed class PronosticoClimaEvidencia
{
...
public sealed class PronosticoClimaPeriodo
{
    public string Clave { get; set; } = string.Empty;
...
public sealed class PronosticoClimaAlerta
{
    public string Clave { get; set; } = string.Empty;
